  ...
  return (
    ...
    <div className="flex justify-between items-center mb-10">
      ...
      <div className="basis-1/2">
        ...
        <a className="tag text-[0.7rem] font-medium uppercase bg-indigo-500 hover:bg-indigo-800 text-neutral-50 
        rounded-bl-lg border border-indigo-800 px-2">{post.content} </a>
      </div>
      {/* CONTENTS */}
      ...
      <button className="basis-1/2 grid justify-items-end tracking-tight transition duration-500 ease  select-none hover:text-indigo-600  focus:outline-none focus:shadow-outline">
        <BsFillEyeFill class="" fontSize="2rem" onClick={() => Router.push("/p/[id]", `/p/${post.id}`)} />
      </button>
      {/* VISUALIZE */}
