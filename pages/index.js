      ...
      <body>
        ...
        <div className="page mx-auto max-w-3xl px-4 sm:px-6 xl:max-w-5xl xl:px-0">
          ...
          <div className="flex justify-evenly items-center text-base leading-5 py-5">
            ...
            <nav>
              {dat.length === 5 ? (
                <div className="rounded-lg bg-indigo-100 border-t-4 border-t-4 border-indigo-500 rounded-b text-indigo-900 px-4 py-3 shadow-md" 
                role="alert">
                  
                  <div className="flex">

                    <div className="py-1">
                      <svg className="fill-current h-6 w-6 text-indigo-500 mr-4"  
                    ...
                    <div>
                      <p className="font-bold">You have exceeded the limit</p>
                      <p className="text-sm">Delete any remember to create other</p>
                    </div>

                  </div>
                </div>
              ) : (
                <a className="anchor-create" onClick={() => Router.push("/create")}>
                  ...
                  select-none hover:text-white hover:bg-indigo-600 focus:outline-none focus:shadow-outline px-4" >Add Reminder</button>
                </a>
              )}
            </nav>
          </div>
