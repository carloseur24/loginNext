        ...
        <form onSubmit={submitData}>
          ...
          <div className="bg-white py-6 rounded-md px-10 max-w-lg shadow-md">
            ...
            <div className="flex justify-center text-2xl font-semibold mx-20">
              ...
              <h1 className="text-center my-auto text-3xl font-bold text-black-500 mb-4">Sign up</h1>
            ...
            <div className="flex my-4 justify-around">
              ...
              <button className="border border-stone-900 font-mono text-sm rounded-md tracking-tight py-2 px-2 flex mx-2 
              items-center text-center transition duration-500 ease select-none hover:text-white hover:bg-stone-600 
              focus:outline-none focus:shadow-outline" onClick={() => signIn()}>
                <BsGithub fontSize="20px" /> Log In With Github
              </button>

              <button className="border border-stone-900 font-mono text-sm 
            ...
            <div className="flex items-center my-1 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 
            ...
            <div className="space-y-4 mt-4 mb-4">
              ...
              <div className="w-full">
                <input type="user" placeholder="Full name" className="px-4 py-2 bg-gray-50 w-full" />
              </div>

              <div className="w-full">
                <input type="email" placeholder="Email Adress" className="px-4 py-2 bg-gray-50 w-full" />
              </div>

              <div className="w-full">
                <input type="password" placeholder="Password" className="px-4 py-2 bg-gray-50 w-full " />
              </div>
            ...
            <div className="flex items-center h-5">
              ...
              <div>
                <a href="#" className="text-sm font-medium text-indigo-600 justify-end hover:underline">Forgot password?</a>
              </div>
